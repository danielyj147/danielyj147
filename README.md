...
<p align="center">
  ...
  <a href="https://patents.google.com/patent/KR102749050B1/en">
    <img src="https://img.shields.io/badge/patents-3%20granted-4285F4?style=for-the-badge" alt="Patents" />
  </a>
</p>
...
Solo-built. JWT auth, RBAC, WebSocket sync with CRDT conflict resolution. Deployed on AWS with Terraform IaC.
...
### [Sentinelle](https://www.code1.co.kr/products/sentinelle)

**Cybersecurity monitoring platform**

Founding engineer. ML threat detection processing 1M+ daily incidents at 95% accuracy. Integrated Splunk, QRadar, Sumo Logic. Deployed at a **national government agency**.

`Spring Boot` `FastAPI` `React` `PostgreSQL`
...
Interactive map with live shuttle positions, time-aware parking availability, geolocation, and dark mode.
...
| Title | ID |
|-------|----|
| ML-based security threat prioritization using real-time SIEM data | [KR102749050B1](https://patents.google.com/patent/KR102749050B1/en) |
| Attack pattern visualization and analysis for security operations | [KR102744022B1](https://patents.google.com/patent/KR102744022B1/en) |
| Automated log data transformation into standardized formats | [KR102794551B1](https://patents.google.com/patent/KR102794551B1/en) |
...
![Bedrock](https://img.shields.io/badge/Bedrock-FF9900.svg?logo=amazon-aws&logoColor=white)
