...
Solo-built from scratch. JWT auth, role-based access control, WebSocket sync with CRDT conflict resolution. Deployed on AWS with Terraform IaC.
...
Founding engineer (3rd hire). Built ML threat detection pipeline processing 1M+ daily incidents at 95% accuracy. Integrated Splunk, QRadar, Sumo Logic. Now deployed at the **National Election Commission of South Korea**.
